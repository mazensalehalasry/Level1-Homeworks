-Write a function named calculateDogAge that
	-Takes 1 argument: your dog age
	-Calculates your dog's age based on the conversion rate of 1 human year to 7 dog years
	-outputs the result to the console like so: "Your doggie is NN years old in dog years!"
	-The function must return an object that has the dog year as a property inside it
